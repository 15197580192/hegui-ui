  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        ...
        <a-button type="primary" icon="plus" @click="$refs.modal.edit(1)">新建</a-button>
...
import AvatarModal from './modules/AvatarModal1'
  ...
  data () {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        // const list = [{ invoiceId: 1 }]
        return getInvoiceList(requestParameters).then((res) => {
          // console.log(res)
